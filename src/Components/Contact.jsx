        ...
        <div className="px-10 md:w-[480px] py-15">
          ...
          >
            ...
            <div className="mt-10">
              <button
                type="submit"
                className="group flex w-full items-center justify-center gap-2 rounded-xl bg-indigo-700 px-4 py-3 text-sm font-semibold text-white shadow-[0_8px_24px_rgba(67,56,202,0.2)] transition duration-300 hover:-translate-y-0.5 hover:bg-indigo-500 hover:shadow-[0_12px_30px_rgba(99,102,241,0.35)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-300"
              >
