  ...
  return (
    <>
      <div>
        ...
        <div className="flex flex-col md:flex-row gap-10 pt-5 justify-center md:my-20 px-4 md:px-10 w-full ">
          <div className="md:aspect-[16/9]  w-[90%] md:w-[30%] mx-5 overflow-hidden hover:scale-105 transition-all duration-300 rounded-2xl hover:shadow-[0_0_25px_#14b8a6]">
            <img src={image} alt="" className="w-full h-full object-cove" />
          </div>
          <div className="w-full lg:w-[50%] lg:ps-10 lg:mx-20">
            <h1 className=" text-2xl md:text-4xl text-gray-200 italic text-center items-center flex gap-2 px-5 lg:px-20">
            ...
            <div className="mt-6 mx-3 text-gray-300  px-4 lg:px-20 text-[16px] md:text-[20px] font-light bg-[#43485734] py-10 md:my-10 rounded-2xl shadow-lg group transition duration-300 hover:scale-102 hover:shadow-[0_0_25px_#14b8a6] ">
              <p>
