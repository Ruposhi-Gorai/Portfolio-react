  ...
  return (
    <>
      <div className=" font-pop py-2 mt-8 ">
        ...
        <div className=" text-6xl md:text-8xl text-gray-900 font-pop shimmer-text  py-3 ">
          RUPOSHI GORAI
        </div>
        ...
        <button className="bg-gradient-to-r border border-teal-400 shadow-[0_0_25px_5px_rgba(0,255,255,0.2)] hover:shadow-[0_0_25px_5px_rgba(0,255,255,0.5)] text-white py-3 md:py-2 mt-5 px-4 rounded-full cursor-pointer hover:scale-105 transition-transform">
          Hire me 
        </button>
        </div>
      </div>
